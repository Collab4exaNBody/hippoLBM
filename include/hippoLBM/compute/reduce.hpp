...
template <class ResultT>
static inline ParallelExecutionWrapper reset_scratch(CudaMMVector<ResultT>& result,
...
static inline ParallelExecutionWrapper local_reduce(FuncT& func, CudaMMVector<ResultT>& result,
                                                    ParallelExecutionContext* exec_ctx, RegionT& region,
