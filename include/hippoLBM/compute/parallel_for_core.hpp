...
// CPU
/** @brief Traits for the for_all function. */
template <typename Func>
struct ForAllGridTraits {
...
namespace parallel {
template <typename Func, typename... Args>
struct ParallelForFunctorTraits<hippoLBM::wrapper_parallel_for_ijk<Func, Args...>> {
...
namespace parallel {
template <typename Func, typename... Args>
struct ParallelForFunctorTraits<hippoLBM::parallel_for_id_traversal_runner<Func, Args...>> {
  static inline constexpr bool RequiresBlockSynchronousCall = false;
  static inline constexpr bool CudaCompatible = ParallelForFunctorTraits<Func>::CudaCompatible;
};
}  // namespace parallel
namespace parallel {
template <typename Func, typename... Args>
struct ParallelForFunctorTraits<hippoLBM::parallel_for_id_runner<Func, Args...>> {
  static inline constexpr bool RequiresBlockSynchronousCall = false;
  static inline constexpr bool CudaCompatible = ParallelForFunctorTraits<Func>::CudaCompatible;
};
}  // namespace parallel
