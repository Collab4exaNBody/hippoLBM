function(hippolbm_add_plugin PluginName dirname)
  ...
  foreach(SRC ${${PluginName}_SCRS})
    ...
    string(REGEX MATCH "OperatorNodeFactory::instance.*register_factory.*make_variant_operator" SRCGV "${SRC_CONTENT}")
    if(SRCGV)
  ...
  if(GVFILES OR ${PluginName}_SHARED_LIB)
    file(APPEND ${XNB_CMAKE_PACKAGE} "\n# Configuration of hippoLBM's ${PluginName} component\n")
    file(APPEND ${XNB_CMAKE_PACKAGE} "set(ONIKA_BUILD_${PluginName} ON)\n")
  ...
  if(${PluginName}_SHARED_LIB)
    file(APPEND ${XNB_CMAKE_PACKAGE} "\n# Import of hippoLBM's ${PluginName} shared library\n")
