# =========================================
# === create hippolbm-config.cmake file ===
# =========================================
...
set(XNB_CMAKE_PACKAGE ${CMAKE_BINARY_DIR}/hippolbm-config.cmake)
string(TIMESTAMP XNB_BUILD_DATE "%Y-%m-%d %Hh%M:%S")
file(WRITE ${XNB_CMAKE_PACKAGE} "# hippoLBM CMake package (generated on ${XNB_BUILD_DATE})\n\n")
