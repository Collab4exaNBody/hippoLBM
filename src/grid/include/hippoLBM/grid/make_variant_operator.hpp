...
struct MakeVariantOperatorHelper {
  static inline std::shared_ptr<onika::scg::OperatorNode> make_operator(const YAML::Node& node,
                                                                        const onika::scg::OperatorNodeFlavor& flavor) {
...
struct make_variant_operator_t {
  static inline onika::scg::OperatorNodeCreateFunction make_factory(const std::string& opname) {
    onika::scg::OperatorNodeCreateFunction factory =
        [](const YAML::Node& node,
           const onika::scg::OperatorNodeFlavor& flavor) -> std::shared_ptr<onika::scg::OperatorNode> {
      std::shared_ptr<onika::scg::OperatorNode> op =
          MakeVariantOperatorHelper<_OperatorTemplate, Q...>::make_operator(node, flavor);
      return op;
    };
...
static inline constexpr onika::scg::OperatorNodeFactoryGenerator<
    details::make_variant_operator_t<_OperatorTemplate, /*15, 27,*/ 19> >
    make_variant_operator = {};
}
