 ...
 */
template <int Q, Traversal TR, typename FextFunc>
struct bgk {
  ...
  ONIKA_HOST_DEVICE_FUNC inline void operator()(int idx) const {
    ...
    const onika::math::Vec3d Fext = fext_(idx, onika::math::Vec3d{ux, uy, uz});
...
namespace onika {
namespace parallel {
template <int Q, hippoLBM::Traversal Tr, typename FextFunc>
struct ParallelForFunctorTraits<hippoLBM::bgk<Q, Tr, FextFunc>> {
